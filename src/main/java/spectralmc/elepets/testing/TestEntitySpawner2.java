...
public class TestEntitySpawner2 extends Item {

    private final PetManager manager = new PetManager();
    private final PetVariableManager variableManager = new PetVariableManager();

    public TestEntitySpawner2() {
        super(new Properties().maxStackSize(16).group(ITEM_GROUP));
    }
    ...
    public ActionResultType onItemUse(ItemUseContext context) {
        ...
        StatBase petBase = manager.getPetFromString("thunder1");
        if (petBase != null) {
            ...
            entity.getPetBase().setPetGender(variableManager.getGenderFromString("male"));
