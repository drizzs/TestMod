...
public class OreGenBiome extends Biome {
    ...
    public OreGenBiome(){
        ...
        this.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockRegistry.testore.getDefaultState(), ConfigHandler.COMMON.maxTestOreVeinSize.get()), Placement.COUNT_RANGE, new CountRangeConfig(ConfigHandler.COMMON.chanceToSpawnTestOre.get(), ConfigHandler.COMMON.minTestOreSpawnHeight.get(), 0, ConfigHandler.COMMON.maxTestOreSpawnHeight.get())));
